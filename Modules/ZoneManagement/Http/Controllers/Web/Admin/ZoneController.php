...
class ZoneController extends BaseController
{
    ...
    public function export(Request $request): View|Factory|Response|StreamedResponse|string|Application
    {
        ...
        $config = styledExportConfig(
            $data,
            title: 'Zone List',
            summary: ['Total Zones' => $data->count()],
            filters: [
            ...
            fileName: 'zones-' . time() . '.xlsx',
            headings: ['Name', 'Trip Request Volume', 'Active Status'],
        );
        return exportData($data, $request['file'], 'zonemanagement::admin.zone.print', $config);
    }

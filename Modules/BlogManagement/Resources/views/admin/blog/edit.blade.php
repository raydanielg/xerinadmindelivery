...
@section('title', translate('Update_Blog'))
...
@section('content')
    ...
    <div class="main-content">
        <div class="container-fluid">
            <h2 class="fs-20 fw-bold mb-20 text-capitalize">{{translate('Update Blog')}}</h2>
            <form action="{{ route('admin.blog.update', $data->id) }}" id="" enctype="multipart/form-data" class="submit-by-ajax"
                  method="POST">
                @csrf
                @method('put')
                            ...
                            <div class="p-lg-4 p-3 rounded bg-F6F6F6 h-100">
                                ...
                                <div class="mb-20">
                                    ...
                                    <input type="text" class="form-control" id="writer" name="writer"
                                           value="{{ old('writer', $data?->author?->name ?? '') }}" tabindex="3"
                                    ...
                                    <div class="p-lg-4 p-3 rounded bg-F6F6F6">
                                        ...
                                        <div>
                                            ...
                                            <textarea rows="2" type="text" name="meta_description" id="meta_description"
                                                      class="form-control"
                                                      placeholder="{{ translate('write_a_short_description_of_the_blog') }}">{{ old('meta_description', $data->meta_description) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="upload-file-new">
                                            ...
                                            <label class="upload-file-new__wrapper ratio-2-1">
                                                ...
                                                <img class="upload-file-new-img" loading="lazy"
                                                     src="{{ $data->meta_image ? dynamicStorage('storage/app/public/blog/meta-image/' . $data->meta_image) : '' }}"
                                                     data-default-src="{{ $data->meta_image ? dynamicStorage('storage/app/public/blog/meta-image/' . $data->meta_image) : '' }}"
                                                     alt="">
                                            </label>
                                            <div class="overlay">
                                                <div

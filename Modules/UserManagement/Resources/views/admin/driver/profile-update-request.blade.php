                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                        <li><a class="dropdown-item"
                                                               href="{{ route('admin.driver.profile-update-request-list-export', ['status' => request()->get('status') ?? 'all', 'search' => request()->get('search'), 'file' => 'excel']) }}">{{ translate('excel') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            @endcan
                                                        ...
                                                        <div
                                                            ...
                                                            @can('user_view')
                                                                <button data-bs-toggle="modal"
                                                                        data-bs-target="#approvedRejectedModal{{$driver->id}}"
                                                                        data-id="{{$driver->id}}"
                                                                        class="btn btn-outline-info btn-action">
                                                                    <i class="bi bi-eye-fill"></i>
                                                                </button>
                                                                {{--    modal--}}
                                                                <div class="modal fade" id="approvedRejectedModal{{$driver->id}}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <form action="{{route('admin.driver.profile-update-request-approved-rejected', ['id' => $driver->id])}}"
                                                                                                ...
                                                                                                @foreach($driver->old_identification_image as $image)
                                                                                                    <div class="col-md-6 p-2">
                                                                                                        <img class="img-fluid mb-3"
                                                                                                             src="{{ dynamicStorage('storage/app/public/driver/identity/'.$image) }}"
                                                                                                             alt="Not found"
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="submit"
                                                                                            class="btn btn-secondary cmn_reset"
                                                                                            name="status"
                                                                                            value="rejected"
                                                                                    >{{translate('deny')}}</button>
                                                                                    <button type="submit"
                                                                                            class="btn btn-primary cmn_focus"
                                                                                            name="status"

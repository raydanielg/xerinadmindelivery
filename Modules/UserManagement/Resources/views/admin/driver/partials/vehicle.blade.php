                    ...
                    <div class="media flex-wrap gap-3 gap-lg-4">
                        <div class="avatar avatar-135 rounded">
                            <img src="{{ onErrorImage(
                                ...
                                dynamicStorage('storage/app/public/vehicle/model') . '/' . $commonData['driver']?->vehicle?->model?->image,
                ...
                <table class="table table-bordered table-borderX-0 p-lg">
                    <tbody>
                        <tr>
                            ...
                            <td>{{ $commonData['driver']?->vehicle?->fuel_type ? translate($commonData['driver']->vehicle->fuel_type) : '' }}</td>
                        </tr>
                        <tr>
        ...
        <div class="card-body">
            ...
            @foreach ($commonData['driver']->vehicle->documents ?? [] as $document)
                <div class="d-flex align-items-center gap-3 flex-wrap">
                    <a download="{{ $document }}"
                        href="{{ dynamicStorage('storage/app/public/vehicle/document') }}/{{ $document }}"

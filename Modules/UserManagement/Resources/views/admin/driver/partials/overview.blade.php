...
<div class="tab-pane fade active show" role="tabpanel">
    <div class="row g-3">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="wallet-tab-pane" role="tabpanel">
                            <ul class="list-unstyled d-flex flex-column gap-3 text-dark mb-0">
                                <li>
                                    <div class="d-flex gap-3 justify-content-between">
                                        <div class="text-capitalize">{{ translate('Total Level Point') }} <span
                                                class="text-muted">( {{$commonData['driver']?->level?->name}} - {{$otherData['targeted_review_point'] + $otherData['targeted_cancel_point'] + $otherData['targeted_amount_point'] + $otherData['targeted_ride_point']}}/{{$otherData['driver_level_point_goal'] ?? 0}} )</span>
                                        </div>
                                        <span
        ...
        <div class="col-md-6">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="text-dark mb-3 d-flex align-items-center gap-2"><i
                            class="bi bi-paperclip text-primary"></i>
        ...
        @php
            $additionalConfig = AdditionalDataForm::fields(DRIVER);
            $additionalData = $driver->additionalInfo?->additional_data ?? [];
            $textFields = [];
            $fileFields = [];
        ...
        <div class="col-md-6">
            <div class="card h-100">
                <div class="card-body">
                    <h5 class="text-dark mb-20 d-flex align-items-center gap-2"><i
                            class="bi bi-paperclip text-primary"></i>

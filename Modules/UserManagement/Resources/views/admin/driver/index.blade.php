                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                        <li><a class="dropdown-item"
                                                               href="{{ route('admin.driver.export', ['status' => request()->get('status') ?? 'all', 'search' => request()->get('search'), 'file' => 'excel']) }}">{{ translate('excel') }}</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            @endcan
                                                        ...
                                                        <a href="{{ route('admin.driver.show', ['id' => $driver->id]) }}"
                                                           class="media d-inline-flex align-items-center gap-10">
                                                            ...
                                                            <span class="d-flex align-items-center gap-1">
                                                                ...
                                                                @else
                                                                    <span class="fs-14 lh-1" data-bs-toggle="tooltip" title="{{ translate('Unverified') }}">
                                                        ...
                                                        <div
                                                            ...
                                                            @can('user_delete')
                                                                    @if(count($driver->getDriverLastTrip())!=0|| $driver?->userAccount->payable_balance>0 || $driver?->userAccount->pending_balance>0 || $driver?->userAccount->receivable_balance>0)
                                                                        ...
                                                                        @else
                                                                        <button data-url="{{ route('admin.driver.delete', ['id' => $driver->id]) }}"

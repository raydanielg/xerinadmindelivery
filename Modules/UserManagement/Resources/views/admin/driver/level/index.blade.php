                                                    ...
                                                    <td class="level_name">
                                                        <div
                                                            ...
                                                            <img src="{{ onErrorImage(
                                                                    $level?->image,
                                                                    dynamicStorage('storage/app/public/driver/level') . '/' . $level?->image,
                                                        ...
                                                        <td class="status">
                                                            <label class="switcher">
                                                                <input class="switcher_input status-change-level"
                                                                       ...
                                                                       data-title="{{$level->is_active == 0 ? translate('Turn on {level}', replace: ['level' => $level->name]) : translate('Turn off {level}', replace: ['level' => $level->name]) }}?"
                                                        ...
                                                        <div
                                                            ...
                                                            @can('user_delete')
                                                                @if ($level->users->count() < 1)
                                                                    @if($level->sequence != 1)
                                                                            <button data-url="{{ route('admin.driver.level.delete', ['id' => $level->id]) }}"
                                                                                    data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                                                    data-title="{{ translate('Are you sure to delete this Driver Level') }}?"

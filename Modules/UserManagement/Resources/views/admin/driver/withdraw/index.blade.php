                                                                                ...
                                                                                @if($withdrawalMethod['method_fields'][$keyData]['is_required'] && $withdrawalMethod['method_fields'][$keyData]['is_required'] == 1)
                                                                                    <div
                                                                                        ...
                                                                                        <img class="text-primary"
                                                                                             src="{{dynamicAsset('public/assets/admin-module/img/svg/check.svg')}}"
                                                                                             alt="" class="svg">
                                                                                        {{translate('Required')}}
                                                                                    </div>
                                                                                @else
                                        ...
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            @can('user_delete')
                                                @if(!$withdrawalMethod->is_default)
                                                    <a class="btn btn-outline-danger btn-action delete-button"
                                                       href="javascript:"
                                                       title="{{translate('Delete')}}"
                                                       data-url="{{ route('admin.driver.withdraw-method.delete', [$withdrawalMethod->id]) }}"
                                                       data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                       data-title="{{ translate('Are you sure to delete this Withdrawal Method') }}?"

...
class CustomerController extends Controller
{
    ...
    public function profileInfo(Request $request): JsonResponse
    {
        if ($request->user()->user_type == CUSTOMER) {
            ...
            $customer = $this->customerService->findOne(id: auth()->id(), withAvgRelations: $withAvgRelations, relations: ['userAccount', 'level', 'additionalInfo'], withCountQuery: ['customerTrips' => []]);

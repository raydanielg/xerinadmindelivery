    ...
    public function rules()
    {
        return [
            ...
            'is_female_driver_requested' => [
                Rule::requiredIf($this->input('type') === RIDE_REQUEST && businessConfig('female_only_ride_service', TRIP_SETTINGS)?->value == 1),
                $this->input('type') === RIDE_REQUEST ? 'boolean' : 'nullable',
            ],

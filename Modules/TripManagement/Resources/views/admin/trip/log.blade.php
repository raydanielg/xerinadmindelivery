            ...
            <div class="card">
                <div class="card-body pt-5">
                    ...
                    <div class="ride-process-steps position-relative">
                        <div class="ride-progress-custop-wrap d-flex nav align-items-start scrollbar-0 flex-nowrap flex-column flex-sm-row white-nowrap overflow-x-auto">
                            <div class="w-250px steps-item d-flex flex-column align-items-center gap-2 mb-4">
                                <div
                                    class="check-circle p-1 d-flex justify-content-center align-items-center bg-success text-white rounded-circle mb-2">
                                    <i class="bi bi-check2"></i>
                                </div>
                                <div>
                                    <h6 class="text-capitalize text-nowrap mb-2">{{translate('ride_request_by_customer')}}</h6>
                            ...
                            @if($isScheduled)
                                <div class="w-250px steps-item d-flex flex-column align-items-center gap-2 mb-4">
                                    ...
                                    <div>
                                        <h6 class="text-capitalize text-nowrap mb-2">{{translate('scheduled_at')}}</h6>
                            ...
                            <div class="w-250px steps-item d-flex flex-column align-items-center gap-2 mb-4">
                                ...
                                <div>
                                    <h6 class="text-capitalize text-nowrap mb-2">{{translate('request_accepted_by_rider')}}</h6>
                                    @if($accepted)
                            ...
                            <div class="w-250px steps-item d-flex flex-column align-items-center gap-2 mb-4">
                                ...
                                <div>
                                    <h6 class="text-capitalize text-nowrap mb-2">{{translate('ride_out_for_pickup')}}</h6>
                                    @if($outForPickup)
                            ...
                            <div class="w-250px steps-item d-flex flex-column align-items-center gap-2 mb-4">
                                ...
                                <div>
                                    <h6 class="text-capitalize text-nowrap mb-2">{{translate('ride_ongoing_to_destination')}}</h6>
                                    @if($ongoing)
                            ...
                            @if($current_status == 'completed' || $current_status == 'cancelled'|| $current_status == 'failed')
                                <div class="w-250px steps-item d-flex flex-column align-items-center gap-2 mb-4">
                                    ...
                                    <div>
                                        <h6 class=" text-nowrap mb-2">{{translate($current_status)}}</h6>
                                        @if($current_status == 'completed')

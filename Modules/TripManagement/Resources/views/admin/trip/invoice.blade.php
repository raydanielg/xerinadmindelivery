...
<div class="">
    ...
    <div class="text-center mb-3">
        <img width="160"
             src="{{$businessLogo? dynamicStorage("storage/app/public/business/".$businessLogo):dynamicAsset('public/assets/admin-module/img/invoice-logo.png')}}"
             alt="{{$businessName}}">
    </div>
                ...
                <tr>
                    <td class="text-start">
                        <table style="vertical-align:middle">
                            ...
                            <tr>
                                <td style="width:50px">
                                    <img width="33" src="{{dynamicAsset('public/assets/admin-module/img/media/from.png')}}"
                                         alt="">
                                </td>
                                <td>
                        ...
                        <table style="vertical-align:middle; margin-top: 10px">
                            ...
                            <tr>
                                <td style="width:50px">
                                    <img width="33" src="{{dynamicAsset('public/assets/admin-module/img/media/to.png')}}"
                                         alt="">
                                </td>
                                <td>
                                    <div class="d-inline-block ml-3 media-body">
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td style="padding:2px 4px">
                                    <span>:</span> <span
                                        class="fw-medium text-dark">{{ $data?->customer?->first_name }} {{ $data?->customer?->last_name }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:2px 4px">
                                ...
                                <td style="padding:2px 4px">
                                    <span>:</span> <span
                                        class="fw-medium text-dark">{{ $data?->customer?->phone }}</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                    <td>
                        <table>
                            <tr>
                                ...
                                <td style="padding:2px 4px">
                                    <span>:</span> <span
                                        class="fw-medium text-dark">{{ translate($data->payment_method) }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding:2px 4px">
                                ...
                                <td style="padding:2px 4px">
                                    <span>:</span> <span
                                        class="fw-medium text-dark">{{ translate($data->payment_status) }}</span>
                                </td>
                            </tr>
                        </table>
                    </td>

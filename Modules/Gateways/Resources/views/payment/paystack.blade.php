        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <input type="hidden" name="callback_url"
                       value="{{ route('paystack.callback', ['payment_id' => $data->id]) }}">
                <input type="hidden" name="metadata"
                       value="{{ json_encode(['payment_id' => $data->id, 'attribute_id' => $data->attribute_id]) }}"> {{-- For other necessary things you want to add to your payload. it is optional though --}}

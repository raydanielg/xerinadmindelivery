        ...
        <div class="card border-0">
            <div class="card-body">
                <div class="mb-20">
                    ...
                    <p class="fs-14 mb-0">{{ translate('The option you select driver will have the option to login driver app') }}</p>
                </div>
                <div class="p-xxl-20 p-3 bg-F6F6F6 rounded">
                    <div class="mb-xxl-20 mb-3">
                        ...
                        <p class="fs-14 mb-0">{{ translate('Based on your selection, driver will have the options to login driver app') }}</p>
                    </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 col-xl-4">
                                <div class="custom-checkbox d-flex align-items-start gap-2">
                                    <input type="checkbox" name="driver[manual_login]"
                                           id="driver-manual_login"
                                           class="input-size-20" {{ !isset($loginOptions) || ($loginOptions['manual_login'] ?? 0) == 1 ? 'checked' : '' }}>
                                    <label for="driver-manual_login" class="mb-0">
                                        <h5 class="fs-14 mb-1">{{ translate('Manual Login') }}</h5>
                                        <p class="fs-12 m-0 opacity-75">
                                            {{ translate('By enabling manual login, drivers will get the option to create an account and log in using the necessary credentials & password in the app.') }}
                                        </p>
                                    </label>
                                </div>
                                <span class="error-text justify-content-start" data-error="driver"></span>
                            </div>
                            <div class="col-md-6 col-xl-4">
                                <div class="custom-checkbox d-flex align-items-start gap-2">
                                    <input type="checkbox" name="driver[otp_login]"
                                           id="driver-otp_login"
                                           class="input-size-20" {{ $isOtpEnabled ? '' : 'disabled' }} {{ ($loginOptions['otp_login'] ?? 0) == 1 ? 'checked' : '' }}>
                                    <label for="driver-otp_login" class="mb-0">
                                        <h5 class="fs-14 mb-1">
                                            {{ translate('OTP Login') }}
                                            @if(!$isOtpEnabled)
                                        ...
                                        <p class="fs-12 m-0 opacity-75">
                                            {{ translate('With OTP Login, drivers can log in using their phone number without password.') }}
                                            @if(!$isOtpEnabled)
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="custom-checkbox d-flex align-items-start gap-2">
                                    <input type="checkbox" name="driver[biometric_login]"
                                           id="driver-biometric_login"
                                           class="input-size-20" {{ ($loginOptions['biometric_login'] ?? 0) == 1 ? 'checked' : '' }}>
                                    <label for="driver-biometric_login" class="mb-0">
                                        <h5 class="fs-14 mb-1">{{ translate('Biometric Login') }}</h5>
                                        <p class="fs-12 m-0 opacity-75">
                                            {{ translate('With Biometric Login, drivers can quickly and securely access their accounts by using their fingerprint.') }}
                                        </p>
                                    </label>
                                </div>
                            </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    ...
                    <label class="switcher rounded-pill mb-0">
                        <input class="switcher_input" type="checkbox" name="driver_verification" id="driver_verification" {{ $isOtpEnabled ? '' : 'disabled' }} {{ $isDriverVerificationEnabled ? 'checked' : '' }}>

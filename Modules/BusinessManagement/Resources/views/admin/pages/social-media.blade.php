                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-4 selDiv">
                                    ...
                                    <select name="name" id="social_media_name" class="js-select cmn_focus" required tabindex="1">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input name="link" type="text" id="redirect_link" class="form-control" required
                                           placeholder="{{translate('Ex: https://www.facebook.com/6amtech')}}" tabindex="2">
                                </div>
                            </div>
                            <input type="hidden" id="id" name="id">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-3">
                                    <button class="btn btn-primary cmn_focus" id="save-btn" tabindex="3"
                                            type="submit">{{translate('submit')}}</button>
                                    <button class="btn btn-primary cmn_focus d-none" id="update-btn" tabindex="3"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div
                                                    ...
                                                    @can('business_edit')
                                                        <button type="button"
                                                                data-url="{{ route('admin.business.pages-media.delete-social-link', ['id' => $link->id]) }}"
                                                                data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                                data-title="{{ translate('Are you sure to delete this Social Media Link') }}?"
...
@push('script')
    <script src="{{ dynamicAsset('public/assets/admin-module/js/business-management/pages/social-media.js') }}"></script>

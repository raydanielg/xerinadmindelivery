...
const INTRO_CONTENTS = "intro_contents";
const FOOTER_CONTENTS = "footer_contents";
const FOOTER = "footer";
...
const CUSTOMER_APP_DOWNLOAD = "customer_app_download";
const NEWSLETTER = "newsletter";
const BUTTON_CONTENTS = "button_contents";
const DRIVER_APP_CONTENTS = "driver_app_contents";
const CUSTOMER_APP_CONTENTS = "customer_app_contents";
const PRIORITY_SETUP = "priority_setup";
const CATEGORY_SORTING = "category_sorting";
...
const SCHEDULE_TRIP_SETTINGS = "schedule_trip_settings";
const BLOG_PAGE = "blog_page";
const APP_DOWNLOAD_SETUP = "app_download_setup";
const LOGIN_SETTINGS = "login_settings";

const DEEP_LINKING_SETTINGS = "deep_linking_settings";

const ADDITIONAL_DATA_SETUP = "additional_data_setup";

                    ...
                    <div class="card h-100">
                        <div class="card-header d-flex flex-wrap justify-content-between gap-10 border-0 align-items-center pb-0">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap gap-2 align-items-center">
                                <select class="js-select cmn_focus" id="dateRangeForExpenseStatistics">
                ...
                <div class="col-lg-6 col-xl-6 col-xxl-7">
                    <div class="card h-100">
                        <div class="card-header d-flex flex-wrap justify-content-between gap-10 pb-0 border-0 align-items-center">
                            ...
                            <div class="d-flex flex-wrap flex-sm-nowrap gap-2 align-items-center">
                                <select class="js-select cmn_focus" id="dateRange">
                        ...
                        <div class="d-flex flex-wrap gap-md-3 gap-2">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                    <li>
                                        <a class="dropdown-item" href="{{route('admin.report.expenseReportExport',['file' => 'excel', request()->getQueryString()])}}">
                                            {{translate("Excel")}}
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2 align-items-center">
                                            <a href="{{route('admin.report.singleExpenseReportExport',$trip->id)}}" class="btn btn-outline-primary btn-action">
        ...
        function dateRideTypeWiseExpenseStatistics(date) {
            ...
            $.get({
                ...
                success: function (response) {
                    ...
                    let parcelExpense =
                        parseFloat(response.totalExpense.parcel) || 0;

                    let rideExpense =
                        parseFloat(response.totalExpense.ride_request) || 0;

                    let scheduleRide =
                        parseFloat(response.totalExpense.scheduled) || 0;

                    $("#parcelExpense").html(
                        parcelExpense.toFixed(point)
                    );

                    $("#rideExpense").html(
                        rideExpense.toFixed(point)
                    );

                    $("#scheduleRide").html(
                        scheduleRide.toFixed(point)
                    );
                    ...
                    $("#totalExpense").html(
                        abbreviateNumber(totalExpense.toFixed(point))
                    );
                    ...
                    if (hasData) {
                        ...
                        expenseChart.updateSeries([1, 1, 1]);
                    }
                },

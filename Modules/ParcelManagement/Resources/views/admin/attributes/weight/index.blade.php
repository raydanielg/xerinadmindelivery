                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="mb-4 text-capitalize">
                                            <label for="min_weight" class="mb-2">{{ translate('minimum_weight') . ' (' . $weightUnit . ')' }}</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-4 text-capitalize">
                                            <label for="max_weight" class="mb-2">{{ translate('maximum_weight') . ' (' . $weightUnit . ')'}} </label>
                                        ...
                                        <div class="d-flex flex-wrap gap-3">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                                    <li><a class="dropdown-item" href="{{ route('admin.parcel.attribute.weight.download', ['status' => request()->get('status') ?? 'all', 'search' => request()->get('search'), 'file' => 'excel']) }}">{{ translate('excel') }}</a></li>
                                                </ul>
                                            </div>
                                            @endcan
                                        </div>
                                                    ...
                                                    <tr id="hide-row-{{$weight->id}}" class="record-row">
                                                        ...
                                                        <td class="action">
                                                            <div class="d-flex justify-content-center gap-2 align-items-center">
                                                                ...
                                                                @can('parcel_delete')
                                                                <button
                                                                    data-url="{{ route('admin.parcel.attribute.weight.delete', ['id' => $weight->id]) }}"
                                                                    data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                                    data-title="{{ translate('Are you sure to delete this Weight') }}?"

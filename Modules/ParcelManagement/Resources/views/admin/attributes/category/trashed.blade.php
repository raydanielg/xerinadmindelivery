                                ...
                                <div class="card-body">
                                    <div class="table-top d-flex flex-wrap gap-10 justify-content-between">
                                        <form action="{{url()->full()}}" class="search-form search-form_style-two"  method="GET">
                                            ...
                                            <button type="submit" class="btn btn-primary cmn_focus">{{ translate('search') }}</button>
                                        </form>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="action">
                                                            <div class="d-flex justify-content-center gap-2 align-items-center">
                                                                ...
                                                                <button
                                                                    data-url="{{ route('admin.parcel.attribute.category.permanent-delete', ['id' => $category->id]) }}"
                                                                    data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                                    data-title="{{ translate('Are you sure to permanently delete this Parcel Category') }}?"

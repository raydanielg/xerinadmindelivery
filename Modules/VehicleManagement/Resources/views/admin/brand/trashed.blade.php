                                                    ...
                                                    <tr id="hide-row-{{ $brand->id }}">
                                                        ...
                                                        <td class="action">
                                                            <div
                                                                ...
                                                                <button data-url="{{ route('admin.vehicle.attribute-setup.brand.permanent-delete', ['id' => $brand->id]) }}"
                                                                    data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                                    data-title="{{ translate('Are you sure to permanently delete this Vehicle Brand') }}?"

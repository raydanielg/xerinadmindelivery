                                                    ...
                                                    <tr id="hide-row-{{ $model->id }}">
                                                        ...
                                                        <td class="action">
                                                            <div
                                                                ...
                                                                <button data-url="{{ route('admin.vehicle.attribute-setup.model.permanent-delete', ['id' => $model->id]) }}"
                                                                    data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                                    data-title="{{ translate('Are you sure to permanently delete this Vehicle Model') }}?"

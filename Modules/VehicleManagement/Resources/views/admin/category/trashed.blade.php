...
@section('content')
    ...
    <i class="bi bi-arrow-repeat"></i>
                                                            ...
                                                            <button
                                                                data-url="{{ route('admin.vehicle.attribute-setup.category.permanent-delete', ['id' => $category->id]) }}"
                                                                data-icon="{{ dynamicAsset('public/assets/admin-module/img/trash.png') }}"
                                                                data-title="{{ translate('Are you sure to permanently delete this Vehicle Category') }}?"

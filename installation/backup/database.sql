...
--
-- Host: localhost
-- Generation Time: May 21, 2026 at 04:08 AM
...
--
-- Database: `hexaride-install-prepare`
--
...
CREATE TABLE `blogs` (
  ...
  `blog_category_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `blog_author_id` char(36) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `driver_details` (
  ...
  `verified_image` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(203, '2026_02_17_161155_create_trip_navigations_table', 18),
(204, '2026_03_05_152743_add_pickup_note_to_trip_requests_table', 18),
(205, '2026_03_08_143441_add_logged_in_via_to_users_table', 18),
(206, '2026_04_27_120000_create_user_additional_infos_table', 19),
(207, '2026_04_27_120100_normalize_additional_data_setup_fields', 19),
(208, '2026_04_28_120000_create_trip_proof_images_table', 19),
(209, '2026_05_02_120000_add_gender_to_users_table', 19),
(210, '2026_05_02_120100_add_is_female_driver_requested_to_trip_requests_table', 19),
(211, '2026_05_07_120000_add_soft_deletes_to_user_additional_infos_table', 19),
(212, '2026_05_10_000001_create_blog_authors_table', 19),
(213, '2026_05_11_000001_make_blog_readable_id_auto_increment', 19),
(214, '2026_05_20_120000_add_is_parcel_delivery_proof_enabled_to_trip_requests_table', 19);
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567001', 'azampesa', '{"gateway":"azampesa","mode":"live","status":"0","app_name":null,"client_id":null,"client_secret":null,"provider":"Azampesa"}', '{"gateway":"azampesa","mode":"test","status":"0","app_name":null,"client_id":null,"client_secret":null,"provider":"Azampesa"}', 'payment_config', 'test', 0, NULL, '2023-11-20 00:14:31', '{"gateway_title":null,"gateway_image":null}'),
('a1b2c3d4-e5f6-7890-abcd-ef1234567002', 'selcom', '{"gateway":"selcom","mode":"live","status":"0","api_key":null,"api_secret":null,"vendor":null}', '{"gateway":"selcom","mode":"test","status":"0","api_key":null,"api_secret":null,"vendor":null}', 'payment_config', 'test', 0, NULL, '2023-11-20 00:14:42', '{"gateway_title":null,"gateway_image":null}'),
...
--
-- Table structure for table `trip_navigations`
--

CREATE TABLE `trip_navigations` (
  `id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `trip_request_id` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `encoded_polyline` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `trip_proof_images`
--

CREATE TABLE `trip_proof_images` (
  `id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `trip_id` char(36) COLLATE utf8mb4_unicode_ci NOT NULL,
  `pickup_proof_images` json DEFAULT NULL,
  `delivery_proof_images` json DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `trip_requests` (
  ...
  `pickup_note` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_parcel_delivery_proof_enabled` tinyint NOT NULL DEFAULT '0',
  `ride_request_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `is_female_driver_requested` tinyint(1) NOT NULL DEFAULT '0',
...
CREATE TABLE `users` (
  ...
  `logged_in_via` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'manual',
...
ALTER TABLE `blogs`
  ...
  ADD KEY `blogs_blog_author_id_foreign` (`blog_author_id`);
...
ALTER TABLE `blog_authors`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `blog_authors_name_unique` (`name`),
...
ALTER TABLE `blog_drafts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `blog_drafts_blog_author_id_foreign` (`blog_author_id`);
...
--
-- Indexes for table `trip_navigations`
--
ALTER TABLE `trip_navigations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `trip_navigations_trip_request_id_unique` (`trip_request_id`);

--
-- Indexes for table `trip_proof_images`
--
ALTER TABLE `trip_proof_images`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `trip_proof_images_trip_id_unique` (`trip_id`);
...
ALTER TABLE `user_additional_infos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `user_additional_infos_user_id_unique` (`user_id`);
...
--
ALTER TABLE `blogs`
  MODIFY `readable_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1001;
...
--
ALTER TABLE `blogs`
  ADD CONSTRAINT `blogs_blog_author_id_foreign` FOREIGN KEY (`blog_author_id`) REFERENCES `blog_authors` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `blog_drafts`
--
ALTER TABLE `blog_drafts`
  ADD CONSTRAINT `blog_drafts_blog_author_id_foreign` FOREIGN KEY (`blog_author_id`) REFERENCES `blog_authors` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `trip_navigations`
--
ALTER TABLE `trip_navigations`
  ADD CONSTRAINT `trip_navigations_trip_request_id_foreign` FOREIGN KEY (`trip_request_id`) REFERENCES `trip_requests` (`id`);

--
-- Constraints for table `user_additional_infos`
--
ALTER TABLE `user_additional_infos`
  ADD CONSTRAINT `user_additional_infos_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;

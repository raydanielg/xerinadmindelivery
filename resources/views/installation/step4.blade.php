        ...
        <div class="p-4 mb-md-3 mx-xl-4 px-md-5">
            ...
            @if(session()->has('error'))
                ...
                <div class="d-flex justify-content-center">
                    <a href="{{ route('force-import-sql') }}" class="btn btn-danger px-sm-5 loader-show">
                        {{translate('Force Import Database')}}</a>
                </div>
            @else
                <div class="d-flex justify-content-center">
                    <a href="{{ route('import_sql',['token'=>bcrypt('step_5')]) }}" class="btn btn-dark px-sm-5 loader-show">{{translate('Click Here')}}</a>
                </div>
            @endif

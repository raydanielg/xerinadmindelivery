...
const DASHBOARD_DATE_FORMAT = "d M h:i a";
const ALL = 'all';
const CUSTOM = 'custom';
const PARCEL = 'parcel';
...
const DRIVER_ACCEPT_RIDE_CANCELLATION_REASON = [
    "Vehicle problem",
...
const DRIVER_ONGOING_RIDE_CANCELLATION_REASON = [
    "Vehicle problem",
    "Customer didn't arrived at pickup point",
    "Couldn't reach to the customer for heavy jam",
    "Customer asked to cancel",
...
const CUSTOMER_ACCEPT_RIDE_CANCELLATION_REASON = [
...
const NOTIFICATION_SUBTITLE = [
    'customer_schedule_trip' => 'Setup push notifications for the schedule trip status updates to customers.',
    'driver_schedule_trip' => 'Setup push notifications for the schedule trip status updates to customers.',
...
const FACE_VERIFICATION_SETTINGS = "face_verification_settings";
